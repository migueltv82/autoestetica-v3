...
- [ ] Las Edge Functions `create-team-member` y `delete-team-member` están activas.
...
- [ ] Están configuradas `VITE_SUPABASE_URL`, `VITE_SUPABASE_ANON_KEY` y `VITE_ORGANIZATION_SLUG`.
- [ ] HTTPS está activo.
