...
export function mapBusinessSettings(data) {
  ...
  return {
    ...
    tiktok: data.tiktok || "",
    clubSectionEnabled: data.club_section_enabled ?? DEFAULT_SETTINGS.clubSectionEnabled,
...
export function buildBusinessSettingsPayload(settings, organizationId) {
  return {
    ...
    club_section_enabled: settings.clubSectionEnabled ?? DEFAULT_SETTINGS.clubSectionEnabled,
