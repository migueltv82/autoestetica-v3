...
export default function ServiceDetail(){
  ...
  const price=service.priceOnRequest||(!service.carPrice&&!service.truckPrice)?<strong>Precio a consultar</strong>:isTwoWheelService(service)?<strong>{money.format(service.carPrice)}</strong>:<><span>Auto <strong>{money.format(service.carPrice)}</strong></span><span>Camioneta <strong>{money.format(service.truckPrice)}</strong></span></>;
