...
export default function ServiceDetail(){
  ...
  const price=service.display?.price===false||service.priceOnRequest||(!service.carPrice&&!service.truckPrice)?<strong>Precio a consultar</strong>:isTwoWheelService(service)?<strong>{formatMoney(service.carPrice)}</strong>:<><span>Auto <strong>{formatMoney(service.carPrice)}</strong></span><span>Camioneta <strong>{formatMoney(service.truckPrice)}</strong></span></>;
