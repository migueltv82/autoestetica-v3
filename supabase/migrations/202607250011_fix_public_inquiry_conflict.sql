-- El teléfono es único solamente entre clientes activos. La cláusula de
-- conflicto debe repetir el predicado del índice parcial para que PostgreSQL
-- pueda identificarlo correctamente.
